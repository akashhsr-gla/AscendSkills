...
import { Home, BookOpen, Video, User, Bell, Calendar, Star, CheckCircle, Flame, Award, ArrowRight, ArrowLeft, CreditCard, Check, X } from 'lucide-react';
        ...
        <div className="flex-1 overflow-y-auto p-6">
          ...
          {activeSection === 'dashboard' && (
                        ...
                        {isExpanded && details && (
                          <div className="mt-4 pt-4 border-t border-gray-200">
                            ...
                            {details.finalAssessment && (
                              <div className="mb-4">
                                <h5 className="font-semibold text-gray-900 mb-2">Assessment Breakdown</h5>
                                <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
                                  <div className="text-center p-2 bg-blue-50 rounded">
                                    <div className="text-sm text-gray-700 font-medium">Communication</div>
                                    <div className="font-semibold text-gray-900">{details.finalAssessment.breakdown.communication}%</div>
                                  </div>
                                  <div className="text-center p-2 bg-green-50 rounded">
                                    <div className="text-sm text-gray-700 font-medium">Technical</div>
                                    <div className="font-semibold text-gray-900">{details.finalAssessment.breakdown.technical}%</div>
                                  </div>
                                  <div className="text-center p-2 bg-yellow-50 rounded">
                                    <div className="text-sm text-gray-700 font-medium">Problem Solving</div>
                                    <div className="font-semibold text-gray-900">{details.finalAssessment.breakdown.problemSolving}%</div>
                                  </div>
                                  <div className="text-center p-2 bg-purple-50 rounded">
                                    <div className="text-sm text-gray-700 font-medium">Confidence</div>
                                    <div className="font-semibold text-gray-900">{details.finalAssessment.breakdown.confidence}%</div>
                                  </div>
                                </div>
                              </div>
                            )}
                            ...
                            {details.finalAssessment && (
                              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                                ...
                                {details.finalAssessment.improvements && details.finalAssessment.improvements.length > 0 && (
                                  <div>
                                    <h6 className="font-semibold text-orange-700 mb-2">Areas for Improvement</h6>
                                    <ul className="text-sm space-y-1">
                            ...
                            {details.questions && details.questions.length > 0 && (
                              <div>
                                <h5 className="font-semibold text-gray-900 mb-3">Questions & Responses</h5>
                                <div className="space-y-4">
                ...
                <div className="space-y-6">
                          ...
                          <div className="mt-4 pt-4 border-t border-gray-200">
                            ...
                            <div className="grid grid-cols-2 md:grid-cols-4 gap-3 mb-4">
                              <div className="text-center p-2 bg-blue-50 rounded">
                                ...
                                <div className="font-semibold">{details.totalQuestions}</div>
                              </div>
                              <div className="text-center p-2 bg-green-50 rounded">
                                <div className="text-sm text-gray-600">Correct</div>
                                <div className="font-semibold text-green-600">{details.correctAnswers}</div>
                              </div>
                              <div className="text-center p-2 bg-red-50 rounded">
                                <div className="text-sm text-gray-600">Incorrect</div>
                                <div className="font-semibold text-red-600">{details.incorrectAnswers}</div>
                              </div>
                              <div className="text-center p-2 bg-yellow-50 rounded">
                                <div className="text-sm text-gray-600">Unanswered</div>
                                <div className="font-semibold text-yellow-600">{details.unansweredQuestions}</div>
                              </div>
                            </div>
                            ...
                            {details.performanceByType && (
                              <div className="mb-4">
                                <h5 className="font-semibold text-gray-900 mb-2">Performance by Question Type</h5>
                            ...
                            {details.questionAnalysis && details.questionAnalysis.length > 0 && (
                              <div>
                                <h5 className="font-semibold text-gray-900 mb-3">Question Analysis</h5>
                                <div className="space-y-4">
                  ...
                  {allQuizzes.length === 0 && (
                    <div className="text-center py-8">
                      ...
                      <p className="text-gray-500 mb-4">Start your first quiz to see your history here!</p>
                      <button 
                        onClick={() => window.location.href = '/quiz'}
                        className="px-6 py-2 bg-green-500 text-white rounded-lg hover:bg-green-600 transition-colors font-medium"
                      >
            ...
            {activeSection === 'subscription' && (
              <div className="bg-white rounded-2xl p-6 shadow-lg border border-gray-100">
                <h3 className="text-xl font-bold text-gray-900 mb-6">Subscription Management</h3>
                ...
                <div className="mb-8">
                  ...
                  {userSubscription ? (
                    <div className="bg-gradient-to-r from-blue-50 to-purple-50 border border-blue-200 rounded-xl p-6">
                      <div className="flex items-center justify-between mb-4">
                        <div>
                          <h5 className="text-xl font-bold text-gray-900 capitalize">
                    ...
                    <div className="bg-gray-50 border border-gray-200 rounded-xl p-6 text-center">
                      ...
                      <h5 className="text-lg font-medium text-gray-900 mb-2">No Subscription Found</h5>
                  ...
                  <div>
                    ...
                    {subscriptionLoading ? (
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                        {availablePlans.map((plan) => (
                          <div key={plan._id} className="border border-gray-200 rounded-xl p-6 hover:shadow-lg transition-shadow">
                    ...
                    {!subscriptionLoading && availablePlans.length === 0 && (
                      <div className="text-center py-8">
                        ...
                        <h5 className="text-lg font-medium text-gray-900 mb-2">No Plans Available</h5>
                        <p className="text-gray-600">Subscription plans are currently not available.</p>
                      </div>
                    )}
                  </div>
                )}
                    ...
                    <div>
                      ...
                      <div className="space-y-3">
                        <button 
                          ...
                          disabled={saving}
                          className={`w-full px-4 py-2 rounded-lg transition-colors font-medium flex items-center justify-center space-x-2 ${
                            saving 
